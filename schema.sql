...
ALTER TYPE DOCUMENT_TYPE ADD VALUE 'LOAN_AGREEMENT';
ALTER TYPE DOCUMENT_TYPE ADD VALUE 'COMPLIANCE_REGULATORY';
ALTER TYPE DOCUMENT_TYPE ADD VALUE 'COLLATERAL';
...
ADD COLUMN file_content oid NOT NULL;
